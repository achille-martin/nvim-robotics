...
| R5 | Handle common Robotics Programming entities | Minimum Robotics Programming entities = `ros`, `python`, `cpp` | MUST | Handling programming entities means: autocomplete, suggestions, documentation when available, formatting, linting |
