...
| R5 | Handle common Robotics Programming entities | Minimum Robotics Programming entities (in order of priority) = `bash`, `python`, `cpp`, `ros`, `ros2` `markdown`, `html`, `matlab` | MUST | Handling programming entities means: autocomplete, suggestions, documentation when available, formatting, linting |
