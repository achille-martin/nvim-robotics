...
function M.open_help()
    ...
    local lines = {
        ...
        "| `S-Tab`| Create new tab (NORMAL mode)                             |",
        "| `Tab`  | Move to next tab (NORMAL mode; repeat to cycle)          |",
        ...
        "| `Tab`  | Show word completion (INSERT/COMMAND-LINE mode)          |",
        "| ====================== TERMINAL MANAGEMENT ====================== |",
        "| `t`    | Toggle persistent floating terminal                      |",
        "| `T`    | Open new terminal in split below (`F2` to switch focus)  |",
        "| ======================= ERROR MANAGEMENT ======================== |",
        ...
        "| `S`    | Open git status                                          |",
        "| `M`    | Open git blame                                           |",
        "| `%`    | Toggle enhanced git diff view (default current vs HEAD)  |",
        "| `@`    | Open enhanced git diff view between current and target   |",
        "| ====================== MARKDOWN MANAGEMENT ====================== |",
